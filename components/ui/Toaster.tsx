  ...
  return (
    <ToasterContext.Provider value={{ showToast }}>
      ...
      <div className="fixed bottom-8 right-8 z-[2000] flex flex-col gap-4">
        {toasts.map((toast) => (
          <div key={toast.id} className={clsx("bg-white rounded-none shadow-lg py-3 px-6 min-w-[320px] max-w-[400px] text-base text-gray-900 flex flex-col gap-1 border border-gray-200", toast.type === "success" && "border-l-4 border-l-green-500", toast.type === "error" && "border-l-4 border-l-primary", toast.type === "loading" && "border-l-4 border-l-gray-500")}>
