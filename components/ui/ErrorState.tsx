  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] py-12 px-8 text-center tablet:min-h-[300px] tablet:py-8 tablet:px-4">
      <div className="max-w-[500px] w-full">
        ...
        <h2 className="text-2xl font-semibold text-gray-700 mb-3 tablet:text-xl">{title}</h2>
        <p className="text-base text-gray-500 leading-relaxed mb-8 tablet:text-sm">{message}</p>
        {showRetry && onRetry && (
